  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
          ...
          <div key={footerlink.title} className={`flex flex-col ss:my-0 my-4 min-w-[150px]`}>
            ...
            <ul className="list-none mt-4">
              {footerlink.links.map((link, index) => (
                <li
                  key={link.name}
                  className={`font-poppins font-normal text-[16px] leading-[24px] text-dimdark hover:text-secondary cursor-pointer ${
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-dark">
        Copyright Ⓒ 2024 Hillside AutoParts. All Rights Reserved .
      </p>
